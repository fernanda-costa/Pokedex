...
public class GetPokemonsPesquisarTask extends AsyncTask<String, Void, List<String>> {
    ...
    public GetPokemonsPesquisarTask(ProgressDialog progressDialog, ListView listPokemons, Context applicationContext, ArrayAdapter<String> adapter, ArrayList dados) {
